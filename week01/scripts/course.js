...
// Get elements
const courseDiv = document.getElementById('cls-lst');
const totalText = document.getElementById('credit-total');
...
function showCourses(courseArray) {
    ...
    totalText.textContent = 'The total credits for course listed above is ' + totalCredits;
}

// Button filters (UPDATED IDs)
